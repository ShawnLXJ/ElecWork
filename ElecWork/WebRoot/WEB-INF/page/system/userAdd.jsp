        ...
        xmlHttp.onreadystatechange = function(){
            if(xmlHttp.readyState==4){
                if(xmlHttp.status==200){
                    ...
                    //alert(data);
                    if(data==1){
                        alert("当前输入的登录名["+loginName+"]已被其他人占用，请重重新输入！");
...
<tr>
       ...
       <td align="center" bgColor="#f5fafe" class="ta_01">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：</td>
        ...
        <tr>
                ...
                <td class="ta_01" bgColor="#ffffff">
                <s:password name="passwordconfirm" type="password"  maxlength="25"  size="22"></s:password>
                </td>
        </tr>
        ...
        <s:select list="#request.isdutylist" name="isDuty" id="isDuty" 
                 listKey="ddlCode" listValue="ddlName" headerKey=""
                  headerValue=""   value="1"        cssStyle="width:155px">
