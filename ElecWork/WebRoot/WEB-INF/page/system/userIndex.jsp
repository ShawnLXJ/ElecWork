...
<%@page import="cn.lxj.swork.util.PageBean"%>
 ...
 <script language="javascript"> 
  ...
  function exportExcel(){
	...
	<HEAD>
        ...
        <script language="javascript" src="${pageContext.request.contextPath }/js/pub.js"></script>
	</HEAD>
			...
			<TBODY>
				...
				<tr>
					...
					<td class="ta_01" align="right">
    					    <input style="font-size:12px; color:black; height=20;width=80" id="BT_Add" type="button" value="查询" name="BT_find" onclick="document.forms[0].submit()">
                            
                     </td>     
                      <td class="ta_01" align="right"> 
                             <%if(popedom.contains("l")){ %>
    						<input style="font-size:12px; color:black; height=20;width=80" id="BT_Add" type="button" value="添加用户" name="BT_Add"  onclick="openWindow('system/elecUserAction_add.do','700','400')">
                             <%} %>
					</td>
                    <td class="ta_01" align="right">
                             <input style="font-size:12px; color:black; height=20;width=80" id="BT_Export" type="button" value="导出Excel" name="BT_Export" onclick="exportExcel()">
                    </td>
                    <td class="ta_01" align="right">
                            <input style="font-size:12px; color:black; height=20;width=80" id="BT_Import" type="button" value="导入Excel" name="BT_Import"  onclick="openWindow('system/elecUserAction_importpage.do','700','400')">
                     </td>
                <td class="ta_01" align="right">
                        <input style="font-size:12px; color:black; height=20;width=80" id="BT_User" type="button" value="人员统计" name="BT_User"  onclick="openWindow('system/elecUserAction_chart.do','700','400')">
                </td>
				</tr>
					
			<tr>
				<td class="ta_01" align="center" bgColor="#f5fafe" colspan=6>			
							...
							<s:if test="#request.userlist!=null  &&  #request.userlist.size()>0">
                                <s:iterator value="%{#request.userlist}" var="user">
									   <tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
        										...
        										<td style="HEIGHT:22px" align="center" width="20%">
                                                         <a href="#" onclick="openWindow('system/elecUserAction_edit.do?userId=<s:property value="%{#user.userId}"/>&viewflag=1','700','400');"  ></a>
        										...
        										<td style="HEIGHT:22px" align="center" width="10%">
                                                    ...
                                                    <%if(popedom.contains("m")){ %>
            											<a href="system/elecUserAction_delete.do?userId=<s:property value='%{#user.userId}' />&userName=<s:property value='%{#user.userName}' />" onclick="return confirm('你确定要删除   <s:property value="%{#user.userName}"/>？')">
