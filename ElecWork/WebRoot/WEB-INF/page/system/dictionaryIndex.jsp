	...
	<HEAD>
		...
		function changetype(){
		  ...
		  if(document.Form1.keyWord.value=="jerrynew"){
		     ...
		     /* 
		     使用ajax框架进行异步操作 使用ajax引擎的send方法发送数据，发送的是form1
		     表单的属性值作为参数，通过system/elecSystemDdlAction_edit.do链接访问后台数据，
		     获取的结果放到disctionnaryEdit.jsp,用disctionnaryEdit.jsp的内容替换到disctionnaryEdit.jsp的Form2中
		     */
...
//增加一行
 function insertRows(){
  ...
  var tempRow=0; 
  var tbl=document.getElementById("dictTbl");
  tempRow=tbl.rows.length; //获取table的行数
		...
		<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				...
				<tr>
                    ...
                    <s:select list="#request.slist" listKey="keyWord" listValue="keyWord" headerKey="jerrynew"  headerValue="" id="keyWord" name="keyWord" cssClass="bg" cssStyle="width:180px"  onchange="changetype()">
