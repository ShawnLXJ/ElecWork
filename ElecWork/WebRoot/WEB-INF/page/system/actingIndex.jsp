...
<link href="${pageContext.request.contextPath }/css/Style.css" type="text/css" rel="stylesheet">
  ...
  if(document.Form1.StaRun.value.length>500){
  
     alert("站点运行情况字数不能超过500字");
     return;
  }
  if(document.Form1.MachRun.value.length>500){
  
     alert("设备运行情况字数不能超过500字");
     return;
  }
  document.Form1.action="system/elecUsualMsgAction_save.do";
  ...
  //var speed = 1 ;
    ...
    function openContenFrame(){
        ...
        setTimeout('openContenFrame()',1000) ;
    }
    function loading(){
	...
	<table id="opperate1" cellspacing="1" cellpadding="5" width="90%" align="center" bgcolor="#f5fafe" style="border:1px solid #8ba7e3" border="0">
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" style="word-break: break-all">
	          <s:textarea name="MachRun" id="MachRun" cssStyle="width: 500px; height: 160px; padding: 1;FONT-FAMILY: 宋体; FONT-SIZE: 9pt" onkeydown="if(event.keyCode==13)addEnter('MachRun');"/>
			</td>
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" style="word-break: break-all">
			<s:textarea name="StaRun" id="StaRun" cssStyle="width: 500px; height: 160px; padding: 1;FONT-FAMILY: 宋体; FONT-SIZE: 9pt" onkeydown="if(event.keyCode==13)addEnter('StaRun');"/>
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#f5fafe" colspan=3>			
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
                            ...
                            <s:if test="#request.usualList!=null">
                                <s:iterator value="%{#request.usualList}" var="usual">
							         <tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
								            <td style="HEIGHT:22px" align="center" width="40%">
									           <s:property value="%{#usual.StaRun}"/>
								            </td>
								            <td style="HEIGHT:22px" align="center" width="40%">
									        <s:property value="%{#usual.MachRun}"/>
								            </td>
								            <td style="HEIGHT:22px" align="center" width="20%">
									           <s:property value="%{#usual.CreateTime}"/>
								            </td>
							             </tr>
                                </s:iterator>
							</s:if>
