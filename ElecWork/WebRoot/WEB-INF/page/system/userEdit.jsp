...
<html>
  <head>
   ...
   <script type="text/javascript" language="JavaScript" src="${pageContext.request.contextPath }/js/calendar.js" charset="gb2312"></script>
	   ...
	   /**
	       * 处理当前用户是否修改了密码，利用md5flag进行标识判断
	             ...
	             * 如果当前用户没有修改密码，则保存运行时，不需要对密码进行加密，直接保存当前密码即可
	                * 设置md5falg == 1
	       */
	   var password1  = document.getElementById("loginPwd").value;
	   var defaultPassword = document.getElementById("loginPwd").defaultValue;
	   /*
 ...
 <body>
    ...
    <table cellSpacing="1" cellPadding="5" width="90%" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
	 ...
	 <tr>
        ...
        <s:hidden name="userId" type="hidden" id="userId"></s:hidden>
          <s:hidden name="md5flag" type="hidden" id="md5flag"></s:hidden>
          <s:hidden name="roleflag" id="roleflag"></s:hidden>
          
     <tr>
         <td align="center" bgColor="#f5fafe" class="ta_01">登&nbsp;&nbsp;录&nbsp;&nbsp;名：
            <td class="ta_01" bgColor="#ffffff">
                    <s:textfield name="loginName" id="loginName"   maxlength="25"  size="20"  readonly="true"></s:textfield>
    ...
    <td class="ta_01" bgColor="#ffffff">
            <s:select list="#request.sexlist" name="sexId" id="sexId" 
                 listKey="ddlCode" listValue="ddlName" headerKey=""
                  headerValue=""   cssStyle="width:155px">
                </s:select>
    </td>
...
<td align="center" bgColor="#f5fafe" class="ta_01">所属单位：</td>
    <td class="ta_01" bgColor="#ffffff">
        <s:select list="#request.jctidlist" name="jctId" id="jctId" 
                 listKey="ddlCode" listValue="ddlName" headerKey=""
                  headerValue=""   cssStyle="width:155px">
         </s:select>
...
<tr>
    <td align="center" bgColor="#f5fafe" class="ta_01">密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
        <td class="ta_01" bgColor="#ffffff">
            <s:password name="loginPwd"  id="loginPwd"   maxlength="25"  size="22" showPassword="true"></s:password>
        </td>
    <td align="center" bgColor="#f5fafe" class="ta_01">确认密码：</td>
        <td class="ta_01" bgColor="#ffffff">
            <s:password name="passwordconfirm"   id="passwordconfirm"  type="password"  maxlength="25"  size="22"></s:password>
        </td>
</tr>
<tr>
...
<td class="ta_01" bgColor="#ffffff">
        <s:textfield name="onDutydate" id="onDutydate"   
            maxlength="50"  size="20"   
            onclick="JavaScript:calendar(document.Form1.onDutydate)">
        </s:textfield>
</td>
<td align="center" bgColor="#f5fafe" class="ta_01">离职日期：</td>
<td class="ta_01" bgColor="#ffffff">
<s:textfield name="offDutydate" id="offDutydate"   
            maxlength="50"  size="20"   
            onclick="JavaScript:calendar(document.Form1.offDutydate)">
       </s:textfield>
</td>
</tr>
